...
%% 双向堆叠图绘制
GO1 = bar(x,y1,0.9,'stacked','EdgeColor','none');
GO2 = bar(x,y2,0.9,'stacked','EdgeColor','none');
hTitle = title('Stacked bidirectional bar chart');
...
XL = get(gca,'xlim');
plot(XL,[0 0],'color', 'k','linewidth',1,'LineStyle','-')
% Legend
hLegend = legend(GO1, ...
